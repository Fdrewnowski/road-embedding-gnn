...
def train_dgi(model, optimizer, train_graphs, val_graphs, epochs):
    cnt_wait = 0
    best = 1e9
    best_t = 0
    dur = []
...
if __name__ == '__main__':
    ...
    import pickle
    with open("./data/raw_data/dgi_results{}.pkl".format(datetime.now().strftime('%Y_%m_%d_%H_%M')), 'wb') as handle:
